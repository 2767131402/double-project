package com.zhenglei.dubbo.common.utils;
...
public class HttpServletRequestParams {
     ...
     */
    public static Map<String, String> getParamMapObject(HttpServletRequest request) {
        ...
        try {
            ...
            Map<String, String> map = StringUtils.isBlank(read) ? null : JSONObject.parseObject(read, Map.class);
